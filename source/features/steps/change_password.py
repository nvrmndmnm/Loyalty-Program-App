...
@step("Я захожу на страницу Изменить пароль")
def step_impl(context):
    context.browser.get(f"{context.base_url}/accounts/1/change-password/")
    time.sleep(1)
...
def step_impl(context):
    ...
    assert context.browser.current_url == context.base_url + "/ru/accounts/1/"
    time.sleep(1)
